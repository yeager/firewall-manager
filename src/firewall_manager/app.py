...
def _settings_path():
    ...
    d = os.path.join(xdg, "firewall-manager")
...
if __name__ == "__main__":
    ...
    def _show_welcome(self, win):
        ...
        page.set_title(_("Welcome to Firewall Manager"))
        page.set_description(_(
            "Manage firewall rules with a simple interface.\n\n✓ View and edit iptables/nftables rules\n✓ Add allow/deny rules easily\n✓ Monitor active connections\n✓ Import/export rule sets"
        ))
